                  ...
                  <div className="aspect-video bg-gradient-to-br from-stone-200 to-stone-300 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        <div
                          className={`p-1.5 rounded-lg ${user.isMuted ? 'bg-red-500/80' : 'bg-green-500/80'}`}
                        >
                          <MicIcon />
                        </div>
                        <div
                          className={`p-1.5 rounded-lg ${user.hasVideo ? 'bg-green-500/80' : 'bg-red-500/80'}`}
                        >
                          <VideoIcon />
                        </div>
                      </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
            ...
            <div className="space-y-3">
              {users.map(user => (
                <div
                  key={user.id}
                  className="flex items-center space-x-3 p-3 bg-white/50 rounded-xl hover:bg-white/70 transition-colors duration-200"
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-stone-500 flex items-center space-x-2">
                      <span
                        className={
                          user.isMuted ? 'text-red-500' : 'text-green-500'
                        }
                      >
                      ...
                      <span
                        className={
                          user.hasVideo ? 'text-green-500' : 'text-red-500'
                        }
                      >
